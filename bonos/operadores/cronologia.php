...
$sqlSelect = "SELECT * FROM comentarios inner join usuarios on usuarios.id_usuario = comentarios.id_usuario where id_bono = $id_bono order by fecha_envio desc";
            ...
            <div class="step-content-wrapper">
                ...
                <div class="step-content">
                    ...
                    <div class="step-title d-flex justify-content-between align-items-center">
                        ...
                        <span class="text-muted d-block"><?php imprimirTiempo($row['fecha_envio']) ?></span>
                    </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            <span class="d-block small text-muted"><?php echo $row['comentario'] ?></span>
                                        </div>
                                    </div>
                                    <!-- End Media -->
                                </div>
