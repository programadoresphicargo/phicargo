...
if (!isset($data['payment_id']) || !isset($data['day_of_week']) || !isset($data['confirmed'])) {
...
$sql = "INSERT INTO `accounting_payment_confirmations` (`payment_id`, `day_of_week`, `confirmed`)
        VALUES (?, ?, ?)
...
$stmt->bind_param('iss', $payment_id, $day_of_week, $confirmed);
