...
if (!isset($data['payment_id']) || !isset($data['day_of_week']) || !isset($data['confirmed']) || !isset($data['amount'])) {
...
$sql = "INSERT INTO `accounting_payment_confirmations` (`payment_id`, `day_of_week`, `confirmed`, `amount`)	
        VALUES (?, ?, ?, ?)
