...
$cn = conectar();
$sqlSelect = "SELECT ID_CORREO, ID_CLIENTE, NOMBRE, NOMBRE_COMPLETO, CORREO, TIPO FROM correos_electronicos INNER JOIN clientes on clientes.id = correos_electronicos.id_cliente";
$result = $cn->query($sqlSelect);

?>
<table class="table-striped js-datatable table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" id="MyTable2">
	<thead>
		<tr>
