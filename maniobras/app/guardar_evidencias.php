...
$uploadedFiles = array(); // Un array para almacenar los nombres de archivo subidos con éxito

if (isset($_FILES['image'])) {
    $uploadDirectory = $targetDir; // Establece la ruta donde deseas guardar las imágenes
