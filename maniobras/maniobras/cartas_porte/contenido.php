                ...
                <div class="row justify-content-between align-items-center flex-grow-1">
                    <div class="col-md">
                        <div class="d-flex justify-content-between align-items-center">
                            <h1 class="card-header-title text-primary">Cartas porte / Maniobras</h1>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-sm-center">
                            ...
                            <div class="col-sm-auto">
                                <div class="row align-items-center gx-0">
                                    <div class="col-auto">
                                        <div class="dropdown">
                                            <button class="btn btn-success dropdown-toggle btn-sm" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation>
                                                <i class="bi bi-funnel-fill"></i> Filtros
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <label class="dropdown-item">
                                                    <input type="checkbox" value="0"> Septiembre 2023
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group input-group-merge input-group-flush">
                                            ...
                                            <select id="searchField" class="form-select">
                                                ...
                                                <option value="client_order_ref">Referencia cliente</option>
