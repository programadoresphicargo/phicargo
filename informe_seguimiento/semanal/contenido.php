            ...
            <div class="page-header page-header-light page-header-reset navbar-expand-lg">
                <div class="navbar-nav">
                    <div class="row align-items-center flex-grow-1">
                        <div class="col">
                            <!-- Logo -->
                            <h1 class="text-white">Semana: <?php echo $_GET['semana'] ?></h1>
                            <h2 class="text-white"><?php echo $_GET['fechaInicial'] . ' al ' . $_GET['fechaFinal'] ?></h2>
                            <!-- End Logo -->
                        </div>
                        ...
                        <div class="col-auto">
                            <!-- Navbar -->
                            <ul class="list-inline">
                                <a class="btn btn-danger btn-sm" href="index-imprimir.php?fechaInicial=<?php echo $_GET['fechaInicial'] ?>&fechaFinal=<?php echo $_GET['fechaFinal'] ?>&semana=01&opcion=1">Descargar PDF</a>
                            </ul>
                            <!-- End Navbar -->
                        </div>
                    </div>
