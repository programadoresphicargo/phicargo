...
import FormularioCorreo from './correos_electronicos/formulario';
...
const fieldValidations = {
    ...
    operador_id: { required: true, message: 'El campo Operador es requerido' },
    vehicle_id: { required: true, message: 'El campo Vehiculo es requerido' },
        ...
        axios.post('/phicargo/modulo_maniobras/codigos/comprobar_disponibilidad.php?id_maniobra=' + id_maniobra)
            .then((response) => {
                ...
                if (Array.isArray(datos) && datos.length > 0) {
                    ...
                    datos.forEach((item) => {
                        const mensaje = 'Equipo: ' + item.equipo + ' en ' + item.estado;
                ...
                axios.post('/phicargo/modulo_maniobras/maniobra/finalizar_maniobra.php?id_maniobra=' + id_maniobra)
                    .then((response) => {
                        ...
                        if (data.success) {
                            ...
                            enviar_correo(id_maniobra, 256, 'Iniciando maniobra');
                            handleClose();
                        } else {
                    ...
                    <Grid container m={2}>
                        <Grid lg={12} xs={12} m={1}>
                            <Stack spacing={1} direction="row">
                                {buttonsVisibility.registrar && <Button variant="contained" onClick={validar_form} size='sm' disableElevation>Registrar</Button>}
                                {buttonsVisibility.cancelar && <Button variant="contained" onClick={handleOpenDialog} size='sm' disableElevation>Cancelar</Button>}
                                {buttonsVisibility.guardar_maniobra && <Button variant="contained" size='sm' onClick={validar_form_actualizar} disableElevation>Guardar cambios</Button>}
                                {buttonsVisibility.editar_maniobra && <Button variant="contained" onClick={toggleForm} size='sm' disableElevation>Editar formulario</Button>}
                                {buttonsVisibility.iniciar && <Button variant="contained" onClick={comprobar_equipo} size='sm' disableElevation>Iniciar</Button>}
                                {buttonsVisibility.finalizar && <Button variant="contained" onClick={finalizar_maniobra} size='sm' disableElevation>Finalizar</Button>}
                                {buttonsVisibility.enviar_estatus && <Button variant="contained" onClick={handleClickOpenPE} size='sm' disableElevation>Enviar nuevo estatus</Button>}
                                {buttonsVisibility.reactivar && <Button variant="contained" onClick={reactivar_maniobra} size='sm' disableElevation>Reactivar maniobra</Button>}
                            </Stack>
                        </Grid>
                                        ...
                                        <Grid container spacing={3} p={1}>
                                            ...
                                            <Grid item xs={12} lg={6}>
                                                <SelectOperador
                                                    ...
                                                    disabled={formDisabled}
                                                    error_operador={errors['operador_id']}
                                                />
                                            </Grid>
                                            <Grid item xs={12} lg={6}>
                                                <MyComponent
