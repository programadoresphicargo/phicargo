                            ...
                            <div className="tab-content" id="nav-tabContent">
                                <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                    ...
                                    <div className="col-4 mb-3 mt-3">
                                        <button type="button" className="btn btn-success btn-sm" onClick={actualizar}>Actualizar información</button>
                                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-4 mb-3">
                                            ...
                                            <select className="form-select" id="state_id" name="state_id" value={formData.state_id} onChange={handleInputChange}>
                                                <option value="1">EN USO</option>
                                                <option value="2">BAJA POR VENTA</option>
                                                <option value="3">BAJA POR PERDIDA TOTAL</option>
                                                <option value="4">EN REPARACION POR SINIESTRO</option>
                                                <option value="5">EN REPARACIÓN POR FALLAS MECÁNICAS</option>
                                        ...
                                        <div className="col-6 mb-3">
                                            ...
                                            <select className="form-select" id="x_operador_asignado" name="x_operador_asignado" value={formData.x_operador_asignado} onChange={handleInputChange}>
